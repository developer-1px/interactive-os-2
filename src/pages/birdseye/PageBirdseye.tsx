...
import { Treemap } from '@os/ui/Treemap'
...
import { BirdseyeOverlay } from './BirdseyeOverlay'
...
export default function PageBirdseye() {
  ...
  const keyMap = useMemo(() => ({
    'cmd+p': () => {
      ...
      return { type: 'birdseye:quick-open' } as const
    },
  }), [])
  ...
  return (<AriaRoute keyMap={keyMap} label="Birdseye">
