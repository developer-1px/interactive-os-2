...
function makeListBoxData(): NormalizedData {
  return createStore({
    entities: {
...
function makeTreeGridData(): NormalizedData {
  return createStore({
    entities: {
...
function makeAccordionData(): NormalizedData {
  return createStore({
    entities: {
...
function makeAlertDialogData(): NormalizedData {
  return createStore({
    entities: {
...
function makeTabListData(): NormalizedData {
  return createStore({
    entities: {
...
function makeToggleData(): NormalizedData {
  return createStore({
    entities: {
...
function makeToggleGroupData(): NormalizedData {
  return createStore({
    entities: {
...
function makeComboboxData(): NormalizedData {
  return createStore({
    entities: {
...
function makeCheckboxData(): NormalizedData {
  return createStore({
    entities: {
...
function makeDialogData(): NormalizedData {
  return createStore({
    entities: {
      confirm: { id: 'confirm', data: { label: 'Confirm' } },
      cancel: { id: 'cancel', data: { label: 'Cancel' } },
...
function makeDisclosureGroupData(): NormalizedData {
  return createStore({
    entities: {
...
function makeGridData(): NormalizedData {
  return createStore({
    entities: {
...
function makeKanbanData(): NormalizedData {
  return createStore({
    entities: {
...
function makeMenuListData(): NormalizedData {
  return createStore({
    entities: {
...
function makeRadioGroupData(): NormalizedData {
  return createStore({
    entities: {
...
function makeSliderData(): NormalizedData {
  return createStore({
    entities: {
...
function makeSpinbuttonData(): NormalizedData {
  return createStore({
    entities: {
...
function makeSwitchGroupData(): NormalizedData {
  return createStore({
    entities: {
...
function makeToolbarData(): NormalizedData {
  return createStore({
    entities: {
      bold: { id: 'bold', data: { label: 'Bold' } },
      italic: { id: 'italic', data: { label: 'Italic' } },
...
function makeTreeViewData(): NormalizedData {
  return createStore({
    entities: {
...
// --- Component demos (stateful wrappers) ---
