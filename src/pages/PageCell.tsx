...
export default function PageCell() {
  ...
  return (
    <div>
      ...
      <div className="card">
        <div className="grid-header" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 0, borderBottom: '1px solid var(--border-mid)', padding: 'var(--space-xs) var(--space-md)', fontSize: 'var(--type-caption-size)', opacity: 0.6 }}>
          <span>Element</span>
          <span>Role</span>
          <span>Focusable</span>
        </div>
