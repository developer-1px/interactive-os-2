...
defineNodePresentation('cta', {
  ...
  render: (data, locale) => (
    <div className={`${s.cmsHeroActions} ${ax({ layout: 'bar' })}`}>
      <button type="button" className={`${s.cmsHeroCta} ${ax({ role: 'control', surface: 'action', tone: 'accent', interactive: 'button', content: 'text' })} inline-flex items-center border-none`}>
        <LocalizedText value={data.primary as string | LocaleMap} locale={locale} /> <ArrowRight size={16} />
      </button>
      <button type="button" className={`${s.cmsHeroCtaSecondary} ${ax({ role: 'control', surface: 'ghost', interactive: 'button', content: 'text' })} inline-flex items-center`}>
...
defineNodePresentation('pattern', {
  className: `${s.cmsPattern} ${ax({ role: 'control', surface: 'ghost', layout: 'bar', interactive: 'button', content: 'text' })}`,
  render: (data, locale) => (
...
defineNodePresentation('tab-item', {
  tag: 'button',
  className: `${s.cmsTabItem} ${ax({ role: 'control', surface: 'ghost', interactive: 'tab', content: 'text' })} border-none`,
...
defineNodePresentation('showcase-item', {
  tag: 'div',
  className: `${s.cmsShowcaseItem} ${ax({ role: 'control', surface: 'ghost', interactive: 'button', content: 'text' })}`,
  render: (data, locale) => (
...
defineNodePresentation('stat-card', {
  tag: 'div',
  className: `${s.cmsStatCard} ${ax({ role: 'control', surface: 'ghost', interactive: 'button', content: 'text' })}`,
  render: (data, locale) => (
...
defineNodePresentation('section-cta', {
  ...
  render: (data, locale) => (
    <a className={`${s.cmsSectionCtaLink} ${ax({ role: 'control', surface: 'action', tone: 'accent', interactive: 'button', content: 'text' })} inline-flex items-center no-underline`} href={data.href as string}>
