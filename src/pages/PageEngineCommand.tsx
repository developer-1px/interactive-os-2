  ...
  return (
    <div>
      <div className="page-header">
        <h2 className="page-title">Command</h2>
        <p className="page-desc">
          Every user action is a Command with execute() and undo().
          Middleware intercepts every dispatch. Try CRUD operations and watch the log.
        </p>
      </div>
      ...
      <div className="page-section">
        <h3 className="page-section-title">Command</h3>
...
// execute = reduce left, undo = reduce right (reversed).`}</code></pre>
      </div>

      <div className="page-section">
        <h3 className="page-section-title">Middleware</h3>
        <pre className="code-block"><code>{`type Middleware = (next: (cmd: Command) => void) => (cmd: Command) => void
...
// zodSchema()     → rejects invalid mutations before execute`}</code></pre>
      </div>
    </div>
  )
}
