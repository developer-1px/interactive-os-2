...
const renderTrigger = (
  ...
  return (
    <button {...props} className={`${styles.trigger} ${ax({ gap: 'xs', textStyle: 'body', text: 'primary' })} inline-flex items-center`} type="button">
      {label} ▾
    </button>
  )
}
...
const renderMenuItem = (
  ...
  return (
    <div
      {...props}
      className={`${styles.menuitem} ${ax({ textStyle: 'body', text: 'primary' })} flex-row items-center`}
