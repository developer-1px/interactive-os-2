...
import { clipboard, resetClipboard } from '@os/plugins/clipboard'
import { i18nColumns, i18nInitialData } from '../pages/shared/sharedI18nData'
import type { NormalizedData as _NormalizedData } from '@os/store/types'
