...
export function Slider({
  ...
  const renderItem = (_props: React.HTMLAttributes<HTMLElement>, item: Record<string, unknown>, state: NodeState): React.ReactElement => {
    ...
    return (
      <div className={\`\${ax({ role: 'item', content: 'text', layout: 'spread', text: state.focused ? 'bright' : undefined, width: 'full' })}\`} data-focused={state.focused || undefined}>
